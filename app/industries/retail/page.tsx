...
const jsonLd = {
  ...
  "@type": "IndustryRetail",
  "name": "Retail & E-commerce IT Solutions",
  "description": "Digital transformation solutions for retail and e-commerce."
};
...
export default function RetailIndustryPage() {
  ...
  return (
    <IndustryPageLayout
      title="[Write Main Heading: Retail & E-commerce IT Solutions]"
      subtitle="[Write sub-heading: ISO-compliant digital solutions for retail companies. Manage quality documents, automate production workflows, achieve compliance, and optimize workforce management.]"
      heroIcon={AccountBalance}
      heroColorClass="text-purple-700"
      heroBgClass="bg-gradient-to-br from-purple-50 to-white"

      overviewTitle="[Write H2: Digital Transformation for Retail & E-commerce]"
      overviewContent={
        <>
      ...
      whyChooseUsTitle="[Write H2: Why Retail Leaders Trust CannyMinds]"

      ctaBgClass="bg-purple-700"
      jsonLd={jsonLd}
    />
  );
}
