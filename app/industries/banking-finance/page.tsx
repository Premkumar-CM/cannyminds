...
const jsonLd = {
  ...
  "@type": "IndustryPharma", // Or appropriate schema
  "name": "Banking & Finance IT Solutions",
  "description": "Digital transformation solutions for banking and finance sectors."
};
...
export default function BankingFinanceIndustryPage() {
  ...
  const solutions: IndustrySolution[] = [
    {
      ...
      description: "[Write 50-80 words: How CannyECM helps banks/financial institutions manage loan documents, policies, contracts, KYC/AML documentation, SOX compliance, audit trails, etc.]",
      icon: Description,
  ...
  return (
    <IndustryPageLayout
      title="[Write Main Heading: Banking, Finance & Insurance IT Solutions]"
      subtitle="[Write sub-heading: ISO-compliant digital solutions for banking and financial institutions. Manage quality documents, automate production workflows, achieve compliance, and optimize workforce management.]"
      heroIcon={AccountBalance}
      heroColorClass="text-blue-700"
      heroBgClass="bg-gradient-to-br from-blue-50 to-white"

      overviewTitle="[Write H2: Digital Transformation for Banking, Finance & Insurance]"
      overviewContent={
        <>
      ...
      whyChooseUsTitle="[Write H2: Why Financial Services Leaders Trust CannyMinds]"

      ctaBgClass="bg-blue-700"
      jsonLd={jsonLd}
    />
  );
}
